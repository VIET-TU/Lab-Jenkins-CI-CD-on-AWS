    ...
    stages {
        ...
        stage('Upload image to ECR') {
            steps {
                ...
                sh 'docker tag nodejs-random-color:ver-${BUILD_ID} 287925497349.dkr.ecr.ap-southeast-1.amazonaws.com/nodejs-random-color:ver-${BUILD_ID}'
                sh 'docker push 287925497349.dkr.ecr.ap-southeast-1.amazonaws.com/nodejs-random-color:ver-${BUILD_ID}'
            }
        }
    }
}
